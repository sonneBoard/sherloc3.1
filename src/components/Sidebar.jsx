        ...
        {[
          ...
          return (
            <NavLink 
              ...
              className={`flex items-center space-x-4 px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors ${!isOpen && 'justify-center'}`}
            >
              <Icon size={isOpen ? 20 : 28} className="flex-shrink-0 transition-all duration-300" />
              <AnimatePresence>
                {isOpen && (
                  <motion.span 
